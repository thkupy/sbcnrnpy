...
#define nrn_init _nrn_init__na_pxko
#define _nrn_initial _nrn_initial__na_pxko
#define nrn_cur _nrn_cur__na_pxko
#define _nrn_current _nrn_current__na_pxko
#define nrn_jacob _nrn_jacob__na_pxko
#define nrn_state _nrn_state__na_pxko
#define _net_receive _net_receive__na_pxko 
#define _f_rates _f_rates__na_pxko 
#define rates rates__na_pxko 
#define states states__na_pxko 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_na_pxko", _hoc_setdata,
 "expM1_na_pxko", _hoc_expM1,
 "hbeta_na_pxko", _hoc_hbeta,
 "halpha_na_pxko", _hoc_halpha,
 "mbeta_na_pxko", _hoc_mbeta,
 "malpha_na_pxko", _hoc_malpha,
 "rates_na_pxko", _hoc_rates,
 0, 0
};
#define expM1 expM1_na_pxko
#define hbeta hbeta_na_pxko
#define halpha halpha_na_pxko
#define mbeta mbeta_na_pxko
#define malpha malpha_na_pxko
...
#define _gth 0
#define htau_na_pxko _thread1data[0]
#define htau _thread[_gth]._pval[0]
#define hinf_na_pxko _thread1data[1]
#define hinf _thread[_gth]._pval[1]
#define mtau_na_pxko _thread1data[2]
#define mtau _thread[_gth]._pval[2]
#define minf_na_pxko _thread1data[3]
#define minf _thread[_gth]._pval[3]
#define usetable usetable_na_pxko
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "gnabar_na_pxko", 0, 1e+09,
 "usetable_na_pxko", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "mtau_na_pxko", "ms",
 "htau_na_pxko", "ms",
 "gnabar_na_pxko", "mho/cm2",
 "ina_na_pxko", "mA/cm2",
 0,0
};
 ...
 "minf_na_pxko", &minf_na_pxko,
 "hinf_na_pxko", &hinf_na_pxko,
 "mtau_na_pxko", &mtau_na_pxko,
 "htau_na_pxko", &htau_na_pxko,
 "usetable_na_pxko", &usetable_na_pxko,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 na_pxko /home/kuenzel/Dokumente/Python/smallexc/mechanisms/x86_64/na_pxko.mod\n");
...
static int _reset;
static char *modelname = "na_pxko.mod  A fast voltage activated sodium channel with reduced inactivation";
...
double halpha ( _threadargsprotocomma_ double _lv ) {
 ...
 _lTf = pow( 3.0 , ( ( celsius - 22.0 ) / 10.0 ) ) ;
   ...
   _lhalpha = 2.4 * _lTf / ( 1.0 + exp ( ( _lv + haP1 ) / 3. ) ) + 0.8 * _lTf10 / ( 1.0 + exp ( _lv + haP2 ) ) ;
...
double hbeta ( _threadargsprotocomma_ double _lv ) {
 ...
 double _lTf ;
 _lTf = pow( 3.0 , ( ( celsius - 22.0 ) / 10.0 ) ) ;
   _lhbeta = 3.6 * _lTf / ( 1.0 + exp ( - ( _lv + hbP1 ) / hbP2 ) ) ;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/kuenzel/Dokumente/Python/smallexc/mechanisms/na_pxko.mod";
static const char* nmodl_file_text = 
