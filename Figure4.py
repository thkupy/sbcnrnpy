...
if __name__ == '__main__':
    ...
    if os.path.isfile('./results/Fig4a.npy') and Fig4_loadifexists[0]:#Exp-specific file/variable names here
        print("Data for Fig4a found... loading!")
        output4a = np.load('./results/Fig4a.npy', allow_pickle=True)#Exp-specific file/variable names here
        Ex4a = np.load('./results/Fig4a_Ex.npy', allow_pickle=True)#Exp-specific file/variable names here
        Ex4a = Ex4a.tolist()
        P4a = np.load('./results/Fig4a_P.npy', allow_pickle=True)#Exp-specific file/variable names here
        P4a = P4a.tolist()#Exp-specific file/variable names here
    else:
        output4a=[]#Exp-specific file/variable names here
        P4a = basic_parameters_1d(conditions,cores,dur,dt)#Exp-specific file/variable names here
        ...
        np.save('./results/Fig4a.npy',output4a, allow_pickle=True)#Exp-specific file/variable names here
        np.save('./results/Fig4a_P.npy',P4a, allow_pickle=True)#Exp-specific file/variable names here
        np.save('./results/Fig4a_Ex.npy',Ex4a, allow_pickle=True)#Exp-specific file/variable names here
    ###Plot results 
    ...
    if os.path.isfile('./results/Fig4b.npy') and Fig4_loadifexists[1]:#Exp-specific file/variable names here
        print("Data for Fig4b found... loading!")
        output4b = np.load('./results/Fig4b.npy', allow_pickle=True)#Exp-specific file/variable names here
        Ex4b = np.load('./results/Fig4b_Ex.npy', allow_pickle=True)#Exp-specific file/variable names here
        Ex4b = Ex4b.tolist()
        P4b = np.load('./results/Fig4b_P.npy', allow_pickle=True)#Exp-specific file/variable names here
        P4b = P4b.tolist()#Exp-specific file/variable names here
    else:
        output4b=[]#Exp-specific file/variable names here
        P4b = basic_parameters_1d(conditions,cores,dur,dt)#Exp-specific file/variable names here
        ####VARIABLE Parameter for EXP1b###
        P4b['mp']=True
        P4b['var_key']='IPI'
        P4b['titletext']=r'Input frequency'
        P4b['labeltext']=r'Cycle duration (ms)'
        P4b['IPI']=np.round(np.linspace(2.0,7.5,P4b['N']),2)#Exp-specific code here      
        ...
        np.save('./results/Fig4b.npy',output4b, allow_pickle=True)#Exp-specific file/variable names here
        np.save('./results/Fig4b_P.npy',P4b, allow_pickle=True)#Exp-specific file/variable names here
        np.save('./results/Fig4b_Ex.npy',Ex4b, allow_pickle=True)#Exp-specific file/variable names here
    ###Plot results 
    ...
    ###Plot results
    fhandle=plotres_2d(output=output4e,P=P4e,
                       x=np.unique(P4e['IPI']),
                       y=np.unique(P4e['tau_dendsyn']),
                       xlabs=r'IPI (ms)',
                       ylabs=r'Dendritic decay tau (ms)')#x=np.unique(P4e['freq']); xlabs=r'Input frequency (Hz)'
