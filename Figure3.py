...
if __name__ == '__main__':
    ...
    if os.path.isfile('./results/Fig3a.npy') and Fig3_loadifexists[0]:#Exp-specific file/variable names here
        print("Data for Fig3a found... loading!")
        output3a = np.load('./results/Fig3a.npy', allow_pickle=True)#Exp-specific file/variable names here
        Ex3a = np.load('./results/Fig3a_Ex.npy', allow_pickle=True)#Exp-specific file/variable names here
        Ex3a = Ex3a.tolist()
        P3a = np.load('./results/Fig3a_P.npy', allow_pickle=True)#Exp-specific file/variable names here
        P3a = P3a.tolist()#Exp-specific file/variable names here
    else:
        output3a=[]#Exp-specific file/variable names here
        P3a = basic_parameters_1d(conditions,cores,dur,dt)#Exp-specific file/variable names here
        ...
        np.save('./results/Fig3a.npy',output3a, allow_pickle=True)#Exp-specific file/variable names here
        np.save('./results/Fig3a_P.npy',P3a, allow_pickle=True)#Exp-specific file/variable names here
        np.save('./results/Fig3a_Ex.npy',Ex3a, allow_pickle=True)#Exp-specific file/variable names here
    ###Plot results 
    ...
    if os.path.isfile('./results/Fig3b.npy') and Fig3_loadifexists[1]:#Exp-specific file/variable names here
        print("Data for Fig3b found... loading!")
        output3b = np.load('./results/Fig3b.npy', allow_pickle=True)#Exp-specific file/variable names here
        Ex3b = np.load('./results/Fig3b_Ex.npy', allow_pickle=True)#Exp-specific file/variable names here
        Ex3b = Ex3b.tolist()
        P3b = np.load('./results/Fig3b_P.npy', allow_pickle=True)#Exp-specific file/variable names here
        P3b = P3b.tolist()#Exp-specific file/variable names here
    else:
        output3b=[]#Exp-specific file/variable names here
        P3b = basic_parameters_1d(conditions,cores,dur,dt)#Exp-specific file/variable names here
        ...
        np.save('./results/Fig3b.npy',output3b, allow_pickle=True)#Exp-specific file/variable names here
        np.save('./results/Fig3b_P.npy',P3b, allow_pickle=True)#Exp-specific file/variable names here
        np.save('./results/Fig3b_Ex.npy',Ex3b, allow_pickle=True)#Exp-specific file/variable names here
    ###Plot results 
    ...
    ###Plot results
    fhandle=plotres_2d(output=output3e,P=P3e,x=np.unique(P3e['gsyn']),
