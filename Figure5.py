...
def average_over_cyle(D,freq,dt,dur):
    ...
    c=range(0,len(D)-cycsamps,cycsamps)#len(D)-cycsamps to make sure that we do not try to access samples > len(D)
...
if __name__ == '__main__':
    ...
    if os.path.isfile('./results/Fig5a.npy') and Fig5_loadifexists[0]:#Exp-specific file/variable names here
        print("Data for Fig5a found... loading!")
        output5a = np.load('./results/Fig5a.npy', allow_pickle=True)#Exp-specific file/variable names here
        Ex5a = np.load('./results/Fig5a_Ex.npy', allow_pickle=True)#Exp-specific file/variable names here
        Ex5a = Ex5a.tolist()
        P5a = np.load('./results/Fig5a_P.npy', allow_pickle=True)#Exp-specific file/variable names here
        P5a = P5a.tolist()#Exp-specific file/variable names here
    else:
        output5a=[]#Exp-specific file/variable names here
        P5a = basic_parameters_1d(conditions,cores,dur,dt)#Exp-specific file/variable names here
        ...
        np.save('./results/Fig5a.npy',output5a, allow_pickle=True)#Exp-specific file/variable names here
        np.save('./results/Fig5a_P.npy',P5a, allow_pickle=True)#Exp-specific file/variable names here
        np.save('./results/Fig5a_Ex.npy',Ex5a, allow_pickle=True)#Exp-specific file/variable names here
    ###Plot results 
    ...
    if os.path.isfile('./results/Fig5b.npy') and Fig5_loadifexists[1]:#Exp-specific file/variable names here
        print("Data for Fig5b found... loading!")
        output5b = np.load('./results/Fig5b.npy', allow_pickle=True)#Exp-specific file/variable names here
        Ex5b = np.load('./results/Fig5b_Ex.npy', allow_pickle=True)#Exp-specific file/variable names here
        Ex5b = Ex5b.tolist()
        P5b = np.load('./results/Fig5b_P.npy', allow_pickle=True)#Exp-specific file/variable names here
        P5b = P5b.tolist()#Exp-specific file/variable names here
    else:
        output5b=[]#Exp-specific file/variable names here
        P5b = basic_parameters_1d(conditions,cores,dur,dt)#Exp-specific file/variable names here
        ...
        np.save('./results/Fig5b.npy',output5b, allow_pickle=True)#Exp-specific file/variable names here
        np.save('./results/Fig5b_P.npy',P5b, allow_pickle=True)#Exp-specific file/variable names here
        np.save('./results/Fig5b_Ex.npy',Ex5b, allow_pickle=True)#Exp-specific file/variable names here
    ###Plot results 
    ...
    if os.path.isfile('./results/Fig5c.npy') and Fig5_loadifexists[2]:#Exp-specific file/variable names here
        print("Data for Fig5c found... loading!")
        output5c = np.load('./results/Fig5c.npy', allow_pickle=True)#Exp-specific file/variable names here
        Ex5c = np.load('./results/Fig5c_Ex.npy', allow_pickle=True)#Exp-specific file/variable names here
        Ex5c = Ex5c.tolist()
        P5c = np.load('./results/Fig5c_P.npy', allow_pickle=True)#Exp-specific file/variable names here
        P5c = P5c.tolist()#Exp-specific file/variable names here
    else:
        output5c=[]#Exp-specific file/variable names here
        P5c = basic_parameters_1d(conditions,cores,dur,dt)#Exp-specific file/variable names here
        ####VARIABLE Parameter for EXP1b###
        P5c['mp']=True
        P5c['var_key']='gLEAK_d'
        ...
        np.save('./results/Fig5c.npy',output5c, allow_pickle=True)#Exp-specific file/variable names here
        np.save('./results/Fig5c_P.npy',P5c, allow_pickle=True)#Exp-specific file/variable names here
        np.save('./results/Fig5c_Ex.npy',Ex5c, allow_pickle=True)#Exp-specific file/variable names here
    ###Plot results 
    ...
    ###Plot results
    fhandle=plotres_2d(output=output5e,P=P5e,
