...
if __name__ == "__main__":
    ...
    if os.path.isfile("./results/Fig2a.npy") and Fig2_loadifexists[0]:
        print("Data for Fig2a found... loading!")
        output2a = np.load("./results/Fig2a.npy", allow_pickle=True)
        Ex2a = np.load("./results/Fig2a_Ex.npy", allow_pickle=True)
        Ex2a = Ex2a.tolist()
        P2a = np.load("./results/Fig2a_P.npy", allow_pickle=True)
        P2a = P2a.tolist()
    else:
        output2a = []
        P2a = basic_parameters_1d(conditions, cores, dur, dt)
        ...
        # make go!
        output2a.append(myMPhandler(P2a))
        output2a = np.array(output2a)  # Exp-specific file/variable names here
        if P2a["save_examples"]:
            Ex2a = process_examplefiles(P2a)
        np.save("./results/Fig2a.npy", output2a, allow_pickle=True)  #
        np.save("./results/Fig2a_P.npy", P2a, allow_pickle=True)  #
        np.save("./results/Fig2a_Ex.npy", Ex2a, allow_pickle=True)  #
    ###Plot results
    ...
    if (
        os.path.isfile("./results/Fig2b.npy") and Fig2_loadifexists[1]
    ):  # Exp-specific file/variable names here
        print("Data for Fig2b found... loading!")
        output2b = np.load(
            "./results/Fig2b.npy", allow_pickle=True
        )  # Exp-specific file/variable names here
        Ex2b = np.load(
            "./results/Fig2b_Ex.npy", allow_pickle=True
        )  # Exp-specific file/variable names here
        Ex2b = Ex2b.tolist()
        P2b = np.load(
            "./results/Fig2b_P.npy", allow_pickle=True
        )  # Exp-specific file/variable names here
        P2b = P2b.tolist()  # Exp-specific file/variable names here
    else:
        output2b = []  # Exp-specific file/variable names here
        P2b = basic_parameters_1d(
        ...
        np.save(
            "./results/Fig2b.npy", output2b, allow_pickle=True
        )  # Exp-specific file/variable names here
        np.save(
            "./results/Fig2b_P.npy", P2b, allow_pickle=True
        )  # Exp-specific file/variable names here
        np.save(
            "./results/Fig2b_Ex.npy", Ex2b, allow_pickle=True
        )  # Exp-specific file/variable names here
    ###Plot results
    ...
    if (
        os.path.isfile("./results/Fig2c.npy") and Fig2_loadifexists[2]
    ):  # Exp-specific file/variable names here
        print("Data for Fig2c found... loading!")
        output2c = np.load(
            "./results/Fig2c.npy", allow_pickle=True
        )  # Exp-specific file/variable names here
        Ex2c = np.load(
            "./results/Fig2c_Ex.npy", allow_pickle=True
        )  # Exp-specific file/variable names here
        Ex2c = Ex2c.tolist()
        P2c = np.load(
            "./results/Fig2c_P.npy", allow_pickle=True
        )  # Exp-specific file/variable names here
        P2c = P2c.tolist()  # Exp-specific file/variable names here
    else:
        output2c = []  # Exp-specific file/variable names here
        P2c = basic_parameters_1d(
            conditions, cores, dur, dt
        )  # Exp-specific file/variable names here
        ...
        np.save(
            "./results/Fig2c.npy", output2c, allow_pickle=True
        )  # Exp-specific file/variable names here
        np.save(
            "./results/Fig2c_P.npy", P2c, allow_pickle=True
        )  # Exp-specific file/variable names here
        np.save(
            "./results/Fig2c_Ex.npy", Ex2c, allow_pickle=True
        )  # Exp-specific file/variable names here
    ###Plot results
    ...
    if (
        os.path.isfile("./results/Fig2d.npy") and Fig2_loadifexists[3]
    ):  # Exp-specific file/variable names here
        print("Data for Fig2d found... loading!")
        output2d = np.load(
            "./results/Fig2d.npy", allow_pickle=True
        )  # Exp-specific file/variable names here
        Ex2d = np.load(
            "./results/Fig2d_Ex.npy", allow_pickle=True
        )  # Exp-specific file/variable names here
        Ex2d = Ex2d.tolist()
        P2d = np.load(
            "./results/Fig2d_P.npy", allow_pickle=True
        )  # Exp-specific file/variable names here
        P2d = P2d.tolist()  # Exp-specific file/variable names here
    else:
        output2d = []  # Exp-specific file/variable names here
        P2d = basic_parameters_1d(
            conditions, cores, dur, dt
        )  # Exp-specific file/variable names here
        ...
        np.save(
            "./results/Fig2d.npy", output2d, allow_pickle=True
        )  # Exp-specific file/variable names here
        np.save(
            "./results/Fig2d_P.npy", P2d, allow_pickle=True
        )  # Exp-specific file/variable names here
        np.save(
            "./results/Fig2d_Ex.npy", Ex2d, allow_pickle=True
        )  # Exp-specific file/variable names here
    ###Plot results
    ...
    if os.path.isfile("./results/Fig2e.npy") and Fig2_loadifexists[4]:
        ...
        P2e["Number"] = list(range(P2e["TotalN"]))
    ...
    fhandle = plotres_2d(
        ...
        x=np.unique(P2e["D"]),
        y=np.unique(P2e["L"]),
        xlabs=r"Dendrite1 diameter ($\mu$m)",
        ylabs=r"Dendrite1 length ($\mu$m)",
    )
